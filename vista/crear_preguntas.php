...
?>
                    <div class="container" style="padding-top: 1rem; padding-bottom: 4rem;">
                        ...
                        <div class="container" style="padding-top: 2%; margin-bottom: 2%;">
                            <button type="button" class="btn btn-primary" style="margin-bottom: 2%;" onclick='Guardar(1)'>Guardar</button>
                            <?php
                            if ($cap->getEstado() == 1) { ?>
                                <button type="button" class="btn btn-primary" style="margin-bottom: 2%;" onclick='Guardar(2)'>Guardar y Despublicar</button>
                            <?php } else { ?>
                                <button type="button" class="btn btn-primary" style="margin-bottom: 2%;" onclick='Guardar(3)'>Guardar y Publicar</button>
                            <?php } ?>
                            ...
                            <script>
                                function Guardar(accion) {
                                    ...
                                    formData.append("codigo", '<?php echo $cap->getCodigo(); ?>');
                                    $.ajax({
