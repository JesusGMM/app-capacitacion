...
?>
    <div class="container padin">
        ...
        <div class="input-group mb-3">
            ...
            <input id="busqueda-cursos-resueltos" type="text" class="form-control" style="z-index: auto;" onkeyup="buscarCursoResueltos(1,<?php echo $_GET['id']; ?>)" />
        </div>
...
?>
    <div class="container padin">
        <h3 style="text-align: center; margin-bottom: 2%;">El usuario no existe</h3>
    </div>
<?php
}
